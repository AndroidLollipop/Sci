...
console.log(repl("var closure(multiplier, start){num add(){skye = skye + 1; return skye*multiplier}; num skye = start/multiplier-1; return add}")) // no ++ or += yet, unfortunately
console.log(repl("var    parserReliabilityTest    (  multiplier  , start  )    {   num add  ()  {  skye = skye + 1   ; return skye  *  multiplier  }   ; num skye = start  /  multiplier  -  1  ; return add }  ")) // no ++ or += yet, unfortunately
console.log(repl("var clo = closure(1, 10)"))
console.log(repl("var ver = closure(2, 20)"))
...
console.log(repl("clo()"))
console.log(repl("ver()"))
console.log(repl("var rte = parserReliabilityTest (  2  * 3   , 8 * 4   )"))
...
console.log(repl("num fastFibonacci(n){num a = 1; num b = 1;num c = 1; while(n>2){c = a+b; a = b; b = c; n = n-1}; return c}"))
